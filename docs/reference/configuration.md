...
If you want to change the active color to something else (the default is purple_dim),
use the following. For example to use gray:
...
set -g @gruvbox_menu_selected_style "fg=#{@thm_fg},bold,bg=#{@thm_overlay_0}"

# Pane styling options
set -g @gruvbox_pane_status_enabled "no" # set to "yes" to enable
set -g @gruvbox_pane_border_status "off" # set to "yes" to enable
set -g @gruvbox_pane_border_style "fg=#{@thm_overlay_0}"
set -g @gruvbox_pane_active_border_style "##{?pane_in_mode,fg=#{@thm_gray},##{?pane_synchronized,fg=#{@thm_purple_dim},fg=#{@thm_gray}}}"
set -g @gruvbox_pane_left_separator "█"
set -g @gruvbox_pane_middle_separator "█"
set -g @gruvbox_pane_right_separator "█"
set -g @gruvbox_pane_color "#{@thm_green}"
set -g @gruvbox_pane_background_color "#{@thm_surface_0}"
set -g @gruvbox_pane_default_text "##{b:pane_current_path}"
set -g @gruvbox_pane_default_fill "number"
set -g @gruvbox_pane_number_position "left" # right, left

set -g @gruvbox_window_status_style "basic" # basic, rounded, slanted, custom, or none
set -g @gruvbox_window_text_color "#{@thm_surface_0}"
set -g @gruvbox_window_number_color "#{@thm_overlay_2}"
set -g @gruvbox_window_text " #T"
set -g @gruvbox_window_number "#I"
set -g @gruvbox_window_current_text_color "#{@thm_surface_1}"
set -g @gruvbox_window_current_number_color "#{@thm_purple_dim}"
set -g @gruvbox_window_current_text " #T"
set -g @gruvbox_window_current_number "#I"
set -g @gruvbox_window_number_position "left"
set -g @gruvbox_window_flags "none" # none, icon, or text
set -g @gruvbox_window_flags_icon_last " 󰖰" # -
set -g @gruvbox_window_flags_icon_current " 󰖯" # *
set -g @gruvbox_window_flags_icon_zoom " 󰁌" # Z
set -g @gruvbox_window_flags_icon_mark " 󰃀" # M
set -g @gruvbox_window_flags_icon_silent " 󰂛" # ~
set -g @gruvbox_window_flags_icon_activity " 󱅫" # #
set -g @gruvbox_window_flags_icon_bell " 󰂞" # !
# Matches icon order when using `#F` (`#!~[*-]MZ`)
set -g @gruvbox_window_flags_icon_format "##{?window_activity_flag,#{E:@gruvbox_window_flags_icon_activity},}##{?window_bell_flag,#{E:@gruvbox_window_flags_icon_bell},}##{?window_silence_flag,#{E:@gruvbox_window_flags_icon_silent},}##{?window_active,#{E:@gruvbox_window_flags_icon_current},}##{?window_last_flag,#{E:@gruvbox_window_flags_icon_last},}##{?window_marked_flag,#{E:@gruvbox_window_flags_icon_mark},}##{?window_zoomed_flag,#{E:@gruvbox_window_flags_icon_zoom},} "

# Status line options
set -g @gruvbox_status_left_separator ""
set -g @gruvbox_status_middle_separator ""
set -g @gruvbox_status_right_separator "█"
set -g @gruvbox_status_connect_separator "yes" # yes, no
set -g @gruvbox_status_fill "icon"
set -g @gruvbox_status_module_bg_color "#{@thm_surface_0}"
```

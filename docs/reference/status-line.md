...
status-\* options. This ensures the gruvbox options (such as colors and
...
tmux:
  styles:
    ...
    untracked: '#[fg=#{@thm_purple_dim},bold]'
    stashed: '#[fg=#{@thm_blue},bold]'
    clean: '#[fg=#{@thm_fg2},bold]'
...
set -g @gruvbox_kube_namespace_color "#{@thm_blue}"

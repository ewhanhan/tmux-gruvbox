...
1. Clone this repository to your desired location (e.g.
   ...
   git clone -b v3.2.1 https://github.com/ewhanhan/tmux-gruvbox.git ~/.config/tmux/plugins/tmux-gruvbox
   ```
...
1. Add the Gruvbox plugin:
   ...
   ```bash
   set -g @plugin 'ewhanhan/tmux-gruvbox#v3.2.1' # See https://github.com/ewhanhan/tmux-gruvbox/tags for additional tags
   # ...alongside
